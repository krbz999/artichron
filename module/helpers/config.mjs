...
export const STATUS_CONDITIONS = {
  ...
  physAtkUp: {
    ...
    img: "systems/artichron/assets/icons/conditions/physical-attack.svg",
    hud: { actorTypes: ["hero", "monster"] },
  ...
  physDefUp: {
    ...
    img: "systems/artichron/assets/icons/conditions/physical-defense.svg",
    hud: { actorTypes: ["hero", "monster"] },
  ...
  elemAtkUp: {
    ...
    img: "systems/artichron/assets/icons/conditions/elemental-attack.svg",
    hud: { actorTypes: ["hero", "monster"] },
    reference: "Compendium.artichron.rules.JournalEntry.JjiZqfbpC2YVXV4R.JournalEntryPage.0iBopTnnWkmkN9kK",
  },
  elemAtkDown: {
  ...
  elemDefUp: {
    ...
    img: "systems/artichron/assets/icons/conditions/elemental-defense.svg",
    hud: { actorTypes: ["hero", "monster"] },
    reference: "Compendium.artichron.rules.JournalEntry.JjiZqfbpC2YVXV4R.JournalEntryPage.JBjVW6bkIC4DWWw9",
  },
  elemDefDown: {
  ...
  planAtkUp: {
    ...
    img: "systems/artichron/assets/icons/conditions/planar-attack.svg",
    hud: { actorTypes: ["hero", "monster"] },
    reference: "Compendium.artichron.rules.JournalEntry.JjiZqfbpC2YVXV4R.JournalEntryPage.0iBopTnnWkmkN9kK",
  },
  planAtkDown: {
  ...
  planDefUp: {
    ...
    img: "systems/artichron/assets/icons/conditions/planar-defense.svg",
    hud: { actorTypes: ["hero", "monster"] },
    reference: "Compendium.artichron.rules.JournalEntry.JjiZqfbpC2YVXV4R.JournalEntryPage.JBjVW6bkIC4DWWw9",
  },
  planDefDown: {
