...
export { default as awaitTargets } from "./await-targets.mjs";
export { default as getActorTargets } from "./get-actor-targets.mjs";
...
export { default as simplifyBonus } from "./simplify-bonus.mjs";
export { default as sortObject } from "./sort-object.mjs";
